...
<head>
    ...
    <link href="<?php echo e(asset('/assets/css/bootstrap-theme.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/assets/css/font-awesome.min.css')); ?>" rel="stylesheet">
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <link href="<?php echo e(asset('/assets/css/ie10-viewport-bug-workaround.css')); ?>" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="<?php echo e(asset('/assets/css/style.css')); ?>" rel="stylesheet">
    <!-- bootstrap datepicker -->
    <link href="<?php echo e(asset('/plugin_old/datepicker/datepicker3.css')); ?>" rel="stylesheet">
    ...
    <!--DATE RANGE-->
    <link href="<?php echo e(asset('/plugin_old/daterangepicker/daterangepicker-bs3.css')); ?>" rel="stylesheet">
    <!--CHOOSEN SELECT -->
    <link href="<?php echo e(asset('/plugin_old/chosen/chosen.css')); ?>" rel="stylesheet">
    <!-- bootstrap wysihtml5 - text editor -->
    <link href="<?php echo e(asset('/plugin_old/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/plugin_old//Lobibox/lobibox.css')); ?>" rel="stylesheet">
    <?php echo $__env->yieldContent('css'); ?>
    <style>
        body {
            background: url('<?php echo e(url('/img/backdrop.png')); ?>'), -webkit-gradient(radial, center center, 0, center center, 460, from(#ccc), to(#ddd));
        }
        .loading {
            opacity:0.4;
            background:#ccc url('<?php echo e(url('/img/spin.gif')); ?>') no-repeat center;
            position:fixed;
            width:100%;
            height:100%;
            top:0px;
    ...
    <script src="<?php echo e(asset('/assets/js/ie-emulation-modes-warning.js')); ?>"></script>
...
<nav class="navbar navbar-default navbar-static-top">
    ...
    <div class="header banner" style="background-color:#36b04e;padding:10px;">
        <div class="container">
            <img src="<?php echo e(asset('/img/banner.png')); ?>" class="img-responsive" />
        </div>
    </div>
    <div class="container">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu hidden">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(url('reportedDocuments').'/'.$year); ?>"><i class="fa fa-sticky-note"></i> <?php echo e($year); ?></a></li>
                                <?php endfor; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
...
<footer class="footer">
    <div class="container">
        ...
        <p>&copy; All Rights Reserved 2019 | Version 1.0</p>
...
<script>var loadingState = '<center><img src="<?php echo e(asset('/img/spin.gif')); ?>" width="150" style="padding:20px;"></center>'; </script>
<!-- bootstrap datepicker -->
<script src="<?php echo e(asset('/plugin_old/datepicker/bootstrap-datepicker.js')); ?>"></script>
<script src="<?php echo e(asset('/assets/js/script.js')); ?>?v=1"></script>
<script src="<?php echo e(asset('/assets/js/form-justification.js')); ?>"></script>
<script src="<?php echo e(asset('/plugin_old/daterangepicker/moment.min.js')); ?>"></script>
<!-- DATE RANGE SELECT -->
<script src="<?php echo e(asset('/plugin_old/daterangepicker/daterangepicker.js')); ?>"></script>
<!-- NUMERAL JS -->
<script src="<?php echo e(asset('/assets/js/Numeral-js/src/numeral.js')); ?>"></script>
<!-- SELECT CHOOSEN -->
<script src="<?php echo e(asset('/plugin_old/chosen/chosen.jquery.js')); ?>"></script>
<!-- CKEDITOR -->
<script src="<?php echo e(asset('/plugin_old/ckeditor/ckeditor.js')); ?>"></script>
<script src="<?php echo e(asset('/plugin_old/ckeditor/adapters/jquery.js')); ?>"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo e(asset('/plugin_old/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')); ?>"></script>
<script src="<?php echo e(asset('/plugin_old/Lobibox/Lobibox.js')); ?>"></script>
<?php echo $__env->yieldContent('plugin_old'); ?>
