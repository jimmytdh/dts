...
<?php if(count($document)): ?>
    ...
    <table class="table table-hover table-striped">
        ...
        <?php for($i=0;$i<count($data['received_by']);$i++): ?>
            ...
            <tr>
                <td class="text-bold trackFontSize <?php echo e($received_success); ?>"><?php echo e($data['received_by'][$i]); ?>

                    <br>
                    <small class="text-warning">(<?php echo e($data['section'][$i]); ?>)</small>
                </td>
                <td class="trackFontSize <?php echo e($received_success); ?>">
                ...
                <td class="trackFontSize <?php echo e($received_success); ?>">
                    ...
                    ?>
                    <?php if($data['status'][$i]==1 && $i == count($data['received_by'])-1): ?>
                        Cycle End
                    <?php else: ?>
                        <?php echo e(Rel::duration($start_date,$end_date)); ?>

                    <?php endif; ?>
                </td>
                <td class="trackFontSize <?php echo e($received_success); ?>"><?php echo nl2br($data['remarks'][$i]); ?></td>
                <td class="trackFontSize text-bold <?php echo e($released_info); ?>">
                    <?php echo e($data['released_section_to'][$i]); ?>

                    <br>
                    <?php echo $data['released_status'][$i]; ?>

                </td>
                <td class="trackFontSize <?php echo e($released_info); ?>">
                    <?php echo e($data['released_date'][$i]); ?>

                    <br>
                    <?php echo e($data['released_time'][$i]); ?>

                </td>
                <td class="trackFontSize <?php echo e($released_info); ?>"><?php echo nl2br($data['released_remarks'][$i]); ?></td>
            </tr>
        <?php endfor; ?>
        </tbody>
    </table>
