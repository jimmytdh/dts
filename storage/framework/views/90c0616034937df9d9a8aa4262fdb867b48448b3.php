...
<form method="post" id="form" action="<?php echo e(asset('prr_supply_post')); ?>">
            ...
            <section class="invoice">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="align"><img src="<?php echo e(asset('resources/img/f1.jpg')); ?>" width="100"></td>
                    </tr>
                </table>
                <table class="letter-head" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3">PR Date: <input class="DatePicker" value="<?php echo e(date("m/d/Y")); ?>" name="pr_date" required></td>
                    </tr>
                    <tr>
                        <td colspan="2">Section/Unit:</td>
                        <td colspan="5"><?php echo e(Section::find(Auth::user()->section)->description); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="23%">
                            ...
                            <select  class="chosen-select-static form-control" onchange="get_designation($(this),'section',true)" name="requested_by" required>
                                <option value="<?php echo e($requestedBy->id); ?>"><?php echo e($requestedBy->fullname); ?></option>
                                <?php foreach($headSection as $row): ?>
                        ...
                        <td>
                            ...
                            <select class="chosen-select-static form-control" onchange="get_designation($(this),'division',true);" name="division_head" required>
                                <option value="<?php echo e($recommendingApproval->id); ?>"><?php echo e($recommendingApproval->fullname); ?></option>
                                <?php foreach($headDivision as $row): ?>
                                    <option value="<?php echo e($row->id); ?>"><?php echo e($row->fullname); ?></option>
                                <?php endforeach; ?>
                            </select>
