...
<?php $__env->startSection('content'); ?>
            ...
            <table class="table table-list table-hover table-striped">
                ...
                <?php foreach($documents as $doc): ?>
                    <tr>
                        ...
                        ?>
                        <td class="text-<?php echo $class?>"><?php echo e(date('M d, Y',strtotime($out->date_in))); ?><br><?php echo e(date('h:i:s A',strtotime($out->date_in))); ?></td>
                        <td class="text-<?php echo $class?>">

                            <?php if($out->received_by==0): ?>
                                <?php
                                    $string = $out->code;
                                    $temp1   = explode(';',$string);
                                    $temp2   = array_slice($temp1, 1, 1);
                            ...
                            <?php if($rel): ?>
                                ...
                                <td class="text-info">
                                    ...
                                    <?php if($rel->status==0): ?>
                                        ...
                                        <a href="<?php echo e(asset('document/report/'.$rel->id .'/cancel/status')); ?>" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> Cancel</a>
                                    <?php endif; ?>
                                </td>
                            <?php else: ?>
                                <td colspan="2" class="text-center" style="vertical-align: middle;">
                                    ...
                                    <?php endif; ?>
                                    <button data-toggle="modal" data-target="#releaseTo" data-id="<?php echo e($doc->tracking_id); ?>" data-route_no="<?php echo e($doc->route_no); ?>" onclick="putRoute($(this))" type="button" class="btn btn-info btn-sm"><i class="fa fa-send"></i> Release To</button>
                                </td>
                            <?php endif; ?>
                        <?php endif; ?>
    ...
    <input type="hidden" id="getsection" value="<?php echo e(asset('getsections/')); ?>">
