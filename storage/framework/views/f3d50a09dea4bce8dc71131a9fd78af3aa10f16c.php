...
<div class="modal fade"  role="dialog" id="document_form">
    <div id="my_modal" class="modal-dialog modal-md" role="document">
        ...
        <div class="modal_content"><center><img src="<?php echo e(asset('/img/spin.gif')); ?>" width="150" style="padding:20px;"></center></div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div id="general_form_content">
                    <center><img src="<?php echo e(asset('/img/spin.gif')); ?>" width="150" style="padding:20px;"></center>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="pr_paperSize" style="z-index:99999;">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div class="col-xs-4">
                    <a href="<?php echo e(asset('prr_supply_pdf/letter')); ?>" class="text-success" target="_blank">
                        <i class="fa fa-file-pdf-o fa-5x"></i><br>
                        Letter
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="<?php echo e(asset('prr_supply_pdf/a4')); ?>" class="text-info" target="_blank">
                        <i class="fa fa-file-pdf-o fa-5x"></i><br>
                        A4
                    </a>
                </div>
                <div class="col-xs-4">
                    <a href="<?php echo e(asset('prr_supply_pdf/legal')); ?>" class="text-warning" target="_blank">
                        <i class="fa fa-file-pdf-o fa-5x"></i><br>
                        Legal
                    </a>
                </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="deletePR">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="<?php echo e(asset('prr_supply_remove')); ?>" method="post">
                    <?php echo e(csrf_field()); ?>
