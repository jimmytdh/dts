...
<table class="table table-hover table-striped table-info">
    ...
    <tr class="<?php echo e($filter[0]); ?>">
        ...
        <td>
            ...
            <textarea name="description" <?php echo e($status); ?> class="form-control" rows="10" style="resize: vertical;"><?php echo ($desc); ?></textarea>
        </td>
    </tr>
...
<div class="modal-footer">
    <?php if(Session::get('doc_type') == 'PRR_S' || $document->doc_type == "PRR_S"): ?>
    ...
    <?php elseif(Session::get('doc_type') == 'PRR_M'): ?>
        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
        <a href="<?php echo e(asset('prr_meal_page')); ?>" class="btn btn-warning"><i class="fa fa-barcode"></i> View Document</a>
    <?php else: ?>
        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
        <?php if(!$status): ?>
