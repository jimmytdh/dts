...
<div class="modal fade"  role="dialog" id="document_form">
    <div id="my_modal" class="modal-dialog modal-md" role="document">
        ...
        <div class="modal_content"><center><img src="{{ asset('/img/spin.gif') }}" width="150" style="padding:20px;"></center></div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div id="general_form_content">
                    <center><img src="{{ asset('/img/spin.gif') }}" width="150" style="padding:20px;"></center>
                </div>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
