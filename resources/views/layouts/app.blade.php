...
<head>
    ...
    <link href="{{ asset('/plugin_old/datepicker/datepicker3.css') }}" rel="stylesheet">
    ...
    <!--DATE RANGE-->
    <link href="{{ asset('/plugin_old/daterangepicker/daterangepicker-bs3.css') }}" rel="stylesheet">
    <!--CHOOSEN SELECT -->
    <link href="{{ asset('/plugin_old/chosen/chosen.css') }}" rel="stylesheet">
    <!-- bootstrap wysihtml5 - text editor -->
    <link href="{{ asset('/plugin_old/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}" rel="stylesheet">
    <link href="{{ asset('/plugin_old//Lobibox/lobibox.css') }}" rel="stylesheet">
    @yield('css')
    <style>
        body {
        ...
        .loading {
            opacity:0.4;
            background:#ccc url('{{ url('/img/spin.gif')}}') no-repeat center;
            position:fixed;
            width:100%;
            height:100%;
            top:0px;
...
<nav class="navbar navbar-default navbar-static-top">
    ...
    <div class="header banner" style="background-color:#36b04e;padding:10px;">
        <div class="container">
            <img src="{{ asset('/img/banner.png') }}" class="img-responsive" />
        </div>
    </div>
    <div class="container">
...
<script>var loadingState = '<center><img src="{{ asset('/img/spin.gif') }}" width="150" style="padding:20px;"></center>'; </script>
<!-- bootstrap datepicker -->
<script src="{{ asset('/plugin_old/datepicker/bootstrap-datepicker.js') }}"></script>
<script src="{{ asset('/assets/js/script.js') }}?v=1"></script>
<script src="{{ asset('/assets/js/form-justification.js') }}"></script>
<script src="{{ asset('/plugin_old/daterangepicker/moment.min.js') }}"></script>
<!-- DATE RANGE SELECT -->
<script src="{{ asset('/plugin_old/daterangepicker/daterangepicker.js') }}"></script>
<!-- NUMERAL JS -->
<script src="{{ asset('/assets/js/Numeral-js/src/numeral.js') }}"></script>
<!-- SELECT CHOOSEN -->
<script src="{{ asset('/plugin_old/chosen/chosen.jquery.js') }}"></script>
<!-- CKEDITOR -->
<script src="{{ asset('/plugin_old/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('/plugin_old/ckeditor/adapters/jquery.js') }}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{ asset('/plugin_old/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
<script src="{{ asset('/plugin_old/Lobibox/Lobibox.js') }}"></script>
@yield('plugin_old')
@yield('plugin')
<?php
