                ...
                <div class="alert alert-success ">
                    <span class="text-success">
                        ...
                        <ul>
                            ...
                            <ul>
                                <li><a href="{{ asset('/ppmp_division/msd.pdf') }}" download>MSD PDF</a></li>
                                <li><a href="{{ asset('/ppmp_division/lhsd.pdf') }}" download>LHSD PDF</a></li>
                                <li><a href="{{ asset('/ppmp_division/rd_ard.pdf') }}" download>RD ARD PDF</a></li>
                                <li><a href="{{ asset('/ppmp_division/rled.pdf') }}" download>RLED PDF</a></li>
                            </ul>
                        </ul>
